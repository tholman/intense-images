...
var Intense = (function() {
  ...
  function u(e, t) {
    ...
    if (t) {
      ...
      n(d, l), (d.innerHTML = t), a.appendChild(d);
    }
    R.appendChild(a),
      w(),
  ...
  function m() {
    l(), p(), a(), document.body.removeChild(R), (L = !1), d(!1);
  }
  function w() {
    var e = t(k);
    (E.width = e.w),
      (E.height = e.h),
      (Y = e.fit),
      (N = { w: E.width, h: E.height }),
      (H = { w: window.innerWidth, h: window.innerHeight }),
      (I = { x: H.w - N.w, y: H.h - N.h });
  }
  function A(e) {
    d(e, "intense--loading");
  ...
  function f() {
    R.addEventListener("mousemove", v, !1),
      R.addEventListener("touchmove", h, !1),
      window.addEventListener("resize", w, !1),
      window.addEventListener("keyup", g, !1),
      E.addEventListener("click", m, !1);
  }
  function p() {
    R.removeEventListener("mousemove", v, !1),
      R.removeEventListener("touchmove", h, !1),
  ...
  function h(e) {
    e.preventDefault(),
      (V.xDest = e.touches[0].clientX),
      (V.yDest = e.touches[0].clientY);
  }
  function g(e) {
